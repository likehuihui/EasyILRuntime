...
namespace ILRuntime.Runtime.Generated
{
    unsafe class CoroutineDemo_Binding
    {
        ...
        static StackObject* DoCoroutine_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            CoroutineDemo instance_of_this_method;
            instance_of_this_method = (CoroutineDemo)typeof(CoroutineDemo).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
