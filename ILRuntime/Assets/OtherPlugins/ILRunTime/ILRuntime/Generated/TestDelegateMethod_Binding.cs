...
namespace ILRuntime.Runtime.Generated
{
    unsafe class TestDelegateMethod_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(TestDelegateMethod);
        ...
        static StackObject* Invoke_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            TestDelegateMethod instance_of_this_method;
            instance_of_this_method = (TestDelegateMethod)typeof(TestDelegateMethod).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
