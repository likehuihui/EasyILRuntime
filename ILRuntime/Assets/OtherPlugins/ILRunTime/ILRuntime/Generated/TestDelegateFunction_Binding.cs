...
namespace ILRuntime.Runtime.Generated
{
    unsafe class TestDelegateFunction_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(TestDelegateFunction);
        ...
        static StackObject* Invoke_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            TestDelegateFunction instance_of_this_method;
            instance_of_this_method = (TestDelegateFunction)typeof(TestDelegateFunction).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
