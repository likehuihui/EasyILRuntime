...
namespace JourneyToTheWest
{
    ...
    public partial class JourneyToTheWest_
    {
        ...
        public void GMSendStockOperate(JourneyToTheWest_.CMD_C_StockOperate msg)
        {
            CyNetWriteBuffer buffer = new CyNetWriteBuffer();
        ...
        public void GMSendADMIN_CONTROL(JourneyToTheWest_.CMD_C_AdminControl msg)
        {
            CyNetWriteBuffer buffer = new CyNetWriteBuffer();
        ...
        public void GMSendAdminControl_Max(JourneyToTheWest_.CMD_C_AdminControl_Max_Result msg)
        {
            CyNetWriteBuffer buffer = new CyNetWriteBuffer();
        ...
        public void GMSendDegreeOperate(JourneyToTheWest_.CMD_C_DegreeOperate msg)
        {
            CyNetWriteBuffer buffer = new CyNetWriteBuffer();
